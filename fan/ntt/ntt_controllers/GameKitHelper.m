...
-(void) reportAchievementWithID:(NSString*)identifier percentComplete:(float)percent
{
  ...
  achievement.showsCompletionBanner = YES;
	if (achievement != nil && achievement.percentComplete < percent)
	{
        ...
        NSLog(@"GameCenter Caching Achievement %@", achievement.identifier);
				[self cacheAchievement:achievement];
			}
      
			//TODO: [GKNotificationBanner showBannerWithTitle:achievement.description message:@"Completed!" completionHandler:^{}];
...
-(void) reportAchievementSuffix:(NSString*)suffix percentComplete:(float)percent
{
  [self reportAchievementWithID:[NSString stringWithFormat:@"com.offkilterstudios.fan.%@", suffix] percentComplete:percent];
}
...
-(UIViewController*) getRootViewController
{
  AppController *appDelegate = (AppController *)[[UIApplication sharedApplication] delegate];
	return (UIViewController *)appDelegate.navController.visibleViewController;
}
